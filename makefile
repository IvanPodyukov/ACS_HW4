...
task: main.o input.o inrnd.o output.o quotient.o
	gcc -g -o task main.o input.o inrnd.o output.o quotient.o -no-pie
...
quotient.o: quotient.asm
	nasm -f elf64 -g -F dwarf quotient.asm -l quotient.lst
